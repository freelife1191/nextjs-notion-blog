...
<!-- TOC -->
* [고급 기능 설정 가이드 (Advanced Features Guide)](#고급-기능-설정-가이드-advanced-features-guide)
  * [📖 관련 문서](#-관련-문서)
  * [🏗️ 전체 시스템 아키텍처](#-전체-시스템-아키텍처)
  * [📌 목차](#-목차)
  * [📊 Google Analytics 4 설정](#-google-analytics-4-설정)
    * [📊 설정 플로우 다이어그램](#-설정-플로우-다이어그램)
    * [📊 왜 필요한가요?](#-왜-필요한가요)
    ...
    * [Step 4: Notion Settings에 추가](#step-4-notion-settings에-추가)
      * [Settings 데이터베이스가 있는 경우:](#settings-데이터베이스가-있는-경우)
      * [Settings 데이터베이스가 없는 경우:](#settings-데이터베이스가-없는-경우)
  ...
  * [💰 Google AdSense 설정](#-google-adsense-설정)
    * [💰 설정 플로우 다이어그램](#-설정-플로우-다이어그램-1)
    * [💰 왜 필요한가요?](#-왜-필요한가요-1)
    * [⚠️ 주의사항](#-주의사항)
    * [🚨 필수: Repository 이름 설정](#-필수-repository-이름-설정)
    ...
    * [Step 6: 광고 표시 확인 (승인 후)](#step-6-광고-표시-확인-승인-후)
    * [💡 광고 배치 정보](#-광고-배치-정보)
      * [📍 Auto Ads 작동 방식](#-auto-ads-작동-방식)
      * [📱 반응형 광고 형식](#-반응형-광고-형식)
      * [⚙️ 설정 방법](#-설정-방법)
    * [📱 광고 표시 확인](#-광고-표시-확인)
      * [개발 환경에서 확인:](#개발-환경에서-확인)
      * [프로덕션 환경에서 확인:](#프로덕션-환경에서-확인)
    * [🎯 광고 성과 최적화 팁](#-광고-성과-최적화-팁)
    * [🔧 개발자를 위한 커스터마이징](#-개발자를-위한-커스터마이징)
      * [광고 위치 추가/변경:](#광고-위치-추가변경)
      * [광고 형식 변경:](#광고-형식-변경)
      * [홈페이지에 광고 추가:](#홈페이지에-광고-추가)
    * [⚠️ 문제 해결](#-문제-해결)
      * [광고가 표시되지 않을 때:](#광고가-표시되지-않을-때)
    * [📊 AdSense 성과 확인](#-adsense-성과-확인)
  * [🌐 커스텀 도메인 연결](#-커스텀-도메인-연결)
    * [🌐 설정 플로우 다이어그램](#-설정-플로우-다이어그램-2)
    * [🌐 왜 필요한가요?](#-왜-필요한가요-2)
    * [Step 1: 도메인 구매](#step-1-도메인-구매)
    * [Step 2: DNS 설정](#step-2-dns-설정)
      * [방법 1: Apex 도메인 사용 (`yourblog.com`)](#방법-1-apex-도메인-사용-yourblogcom)
      * [방법 2: 서브도메인 사용 (`blog.yourdomain.com`)](#방법-2-서브도메인-사용-blogyourdomaincom)
    * [Step 3: GitHub Pages 설정](#step-3-github-pages-설정)
    * [Step 4: 코드 수정](#step-4-코드-수정)
      * [1. next.config.ts 수정](#1-nextconfigts-수정)
      * [2. NEXT_PUBLIC_SITE_URL 업데이트](#2-next_public_site_url-업데이트)
      * [3. 배포](#3-배포)
    * [Step 5: 작동 확인](#step-5-작동-확인-1)
    * [🔒 HTTPS 인증서](#-https-인증서)
  * [💬 댓글 시스템 추가](#-댓글-시스템-추가)
    * [💬 설정 플로우 다이어그램](#-설정-플로우-다이어그램-3)
    * [💬 왜 필요한가요?](#-왜-필요한가요-3)
    * [추천 서비스](#추천-서비스)
  ...
  * [🔍 SEO 최적화](#-seo-최적화)
    * [🔍 SEO 최적화 플로우 다이어그램](#-seo-최적화-플로우-다이어그램)
    ...
    * [📝 포스트 작성 시 SEO 팁](#-포스트-작성-시-seo-팁)
      ...
      * [5. 본문 작성 팁](#5-본문-작성-팁)
    * [🗺️ Sitemap 제출](#-sitemap-제출)
      * [Google Search Console](#google-search-console)
      * [Naver Search Advisor](#naver-search-advisor)
    * [📈 색인 확인](#-색인-확인)
  * [📱 소셜 미디어 최적화](#-소셜-미디어-최적화)
  ...
  * [📡 RSS 피드 활용](#-rss-피드-활용)
    ...
    * [📢 RSS 홍보](#-rss-홍보)
  * [⏰ 동기화 주기 변경](#-동기화-주기-변경)
    * [⏰ 설정 플로우 다이어그램](#-설정-플로우-다이어그램-4)
    * [⏰ 기본 동작](#-기본-동작)
    * [📊 주기별 비용 비교](#-주기별-비용-비교)
    * [🖼️ Notion 이미지 링크 만료 문제](#-notion-이미지-링크-만료-문제)
    * [⚙️ GitHub 웹사이트에서 변경하기 (비개발자용)](#-github-웹사이트에서-변경하기-비개발자용)
      * [Step 1: 파일 찾기](#step-1-파일-찾기)
      * [Step 2: Cron 표현식 수정](#step-2-cron-표현식-수정)
      * [Step 3: 저장](#step-3-저장)
    * [🎯 Cron 표현식 이해하기](#-cron-표현식-이해하기)
    * [🚀 수동 배포 (즉시 동기화)](#-수동-배포-즉시-동기화)
      * [방법 1: GitHub Actions 웹사이트](#방법-1-github-actions-웹사이트)
      * [방법 2: 수정 후 대기](#방법-2-수정-후-대기)
    * [⚠️ 주의사항](#-주의사항-1)
      * [GitHub Actions 무료 제한](#github-actions-무료-제한)
      * [제한 초과 시](#제한-초과-시)
      * [배포 실패 알림](#배포-실패-알림)
  * [🎉 완료!](#-완료)
    * [다음 단계](#다음-단계)
...
> **참고**: 이 프로젝트는 **Auto Ads (자동 광고)** 방식을 사용합니다. Publisher ID만 입력하면 Google이 자동으로 최적 위치에 광고를 배치합니다.
...
**✅ Auto Ads (자동 광고)로 구현되어 있습니다!**

이 블로그는 Google AdSense Auto Ads를 사용하여 Google AI가 자동으로 최적 위치에 광고를 배치합니다:

**Auto Ads의 장점:**
- ✅ **자동 최적화**: Google AI가 클릭률이 높은 위치에 자동 배치
- ✅ **간편한 설정**: Publisher ID만 입력하면 끝
- ✅ **수익 극대화**: Google이 실시간으로 광고 위치 최적화
- ✅ **반응형 지원**: 모바일/태블릿/데스크톱 모두 최적화
...
3. **사이드 레일 광고 (Side Rail Ads)**
   - 화면 좌우 여백에 배치
   - 데스크톱 화면에서 효과적

4. **인아티클 광고 (In-article Ads)**
   - 본문 단락 사이에 배치
   - 읽기 경험을 해치지 않도록 최적화

**💡 핵심**: Google AI가 실시간으로 사용자 행동을 분석하여 가장 효과적인 위치에 광고를 자동 배치합니다.
...
3. 배포 후 Google이 자동으로 광고 배치

**설정 완료 후:**
- Google AI가 페이지 구조를 분석
- 최적의 위치에 광고 자동 배치
- 시간이 지남에 따라 수익 최적화
...
- **자동 동기화**: 1시간마다 자동 실행 (GitHub Actions)
- **수동 배포**: 필요시 즉시 배포 가능
